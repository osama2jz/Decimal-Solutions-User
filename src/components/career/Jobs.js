...
const JobPosting = ({ jobData }) => {
  ...
  return (
    <div className="w-[300px] flex-1 aspect-[1.4] overflow-hidden flex flex-col items-center justify-center gap-[10px] rounded-[24px] border-2 border-boxColor md:py-[30px]">
      <h1 className="font-semibold sm:text-[1.6rem] md:mt-0 sm:py-3">
        {jobData?.title}
      </h1>
